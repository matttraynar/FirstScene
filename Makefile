...
# Project:  FirstScene.pro
# Template: app
# Command: /opt/qt/5.5/gcc_64/bin/qmake -spec linux-clang CONFIG+=debug -o Makefile FirstScene.pro
#############################################################################
...
DISTDIR = /home/i7626944/Documents/FirstScene/obj/BlankNGL1.0.0
LINK          = clang++
...
OBJECTS       = obj/main.o \
		obj/NGLScene.o
DIST          = FirstScene.pro include/NGLScene.h src/main.cpp \
		src/NGLScene.cpp
...
Makefile: FirstScene.pro .qmake.cache /opt/qt/5.5/gcc_64/mkspecs/linux-clang/qmake.conf /opt/qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec linux-clang CONFIG+=debug -o Makefile FirstScene.pro
